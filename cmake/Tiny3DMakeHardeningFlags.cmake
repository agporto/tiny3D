...
function(tiny3d_make_hardening_flags hardening_cflags hardening_ldflags)
    unset(${hardening_cflags})
    unset(${hardening_ldflags})

    # -Wall -Wextra -Werror or /W4 /WX are enabled for tiny3d code (not 3rd party)
    if (MSVC)
...
function(tiny3d_make_hardening_definitions hardening_definitions)
