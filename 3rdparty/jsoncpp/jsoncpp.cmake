...
ExternalProject_Add(
    ...
    DOWNLOAD_DIR "${TINY3D_THIRD_PARTY_DOWNLOAD_DIR}/jsoncpp"
    UPDATE_COMMAND ""
    ...
    BUILD_BYPRODUCTS
        <INSTALL_DIR>/${Tiny3D_INSTALL_LIB_DIR}/${CMAKE_STATIC_LIBRARY_PREFIX}jsoncpp${CMAKE_STATIC_LIBRARY_SUFFIX}
)

ExternalProject_Get_Property(ext_jsoncpp INSTALL_DIR)
set(JSONCPP_INCLUDE_DIRS ${INSTALL_DIR}/include/) # "/" is critical.
set(JSONCPP_LIB_DIR ${INSTALL_DIR}/${Tiny3D_INSTALL_LIB_DIR})
