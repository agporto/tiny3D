...
void pybind_kdtreeflann_declarations(py::module &m) {
    ...
    // tiny3d.geometry.KDTreeSearchParam.Type
...
void pybind_kdtreeflann_definitions(py::module &m) {
    ...
    // tiny3d.geometry.KDTreeSearchParamKNN
    ...
    // tiny3d.geometry.KDTreeSearchParamRadius
    ...
    // tiny3d.geometry.KDTreeSearchParamHybrid
