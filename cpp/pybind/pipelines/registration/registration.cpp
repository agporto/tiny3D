...
void pybind_registration_definitions(py::module &m) {
    ...
    // tiny3d.registration.ICPConvergenceCriteria
    ...
    // tiny3d.registration.RANSACConvergenceCriteria
    ...
    // tiny3d.registration.TransformationEstimation
    auto te = static_cast<
            py::class_<TransformationEstimation,
                       PyTransformationEstimation<TransformationEstimation>>>(
    ...
    // tiny3d.registration.TransformationEstimationPointToPoint:
    // TransformationEstimation
...
Sets :math:`c = 1` if ``with_scaling`` is ``False``.
    ...
    // tiny3d.registration.TransformationEstimationPointToPlane:
    // TransformationEstimation
    ...
    // tiny3d.registration.CorrespondenceChecker
    auto cc = static_cast<
            py::class_<CorrespondenceChecker,
                       PyCorrespondenceChecker<CorrespondenceChecker>>>(
    ...
    // tiny3d.registration.CorrespondenceCheckerBasedOnEdgeLength:
    // CorrespondenceChecker
...
must hold true for all edges.)");
    ...
    // tiny3d.registration.CorrespondenceCheckerBasedOnDistance:
    // CorrespondenceChecker
    ...
    // tiny3d.registration.CorrespondenceCheckerBasedOnNormal:
    // CorrespondenceChecker
    ...
    // tiny3d.registration.RegistrationResult
