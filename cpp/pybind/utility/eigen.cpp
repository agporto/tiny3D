...
std::vector<EigenVector> py_array_to_vectors_double(
    ...
    for (auto i = 0; i < array_unchecked.shape(0); ++i) {
        ...
        // tiny3d::Vector3dVector binds to py_array_to_vectors_double.
...
void pybind_eigen_definitions(py::module &m) {
    ...
    intvector.attr("__doc__") = docstring::static_property(
            py::cpp_function([](py::handle arg) -> std::string {
                return R"(Convert int32 numpy array of shape ``(n,)`` to tiny3d format.)";
            }),
            py::none(), py::none(), "");
    ...
    doublevector.attr("__doc__") = docstring::static_property(
            py::cpp_function([](py::handle arg) -> std::string {
                return R"(Convert float64 numpy array of shape ``(n,)`` to tiny3d format.)";
            }),
            py::none(), py::none(), "");
    auto vector3dvector =
    ...
    vector3dvector.attr("__doc__") = docstring::static_property(
            py::cpp_function([](py::handle arg) -> std::string {
                return R"(Convert float64 numpy array of shape ``(n, 3)`` to tiny3d format.
...
.. code-block:: python
    ...
    pcd = tiny3d.geometry.PointCloud()
    np_points = np.random.rand(100, 3)

    # From numpy to tiny3d
    pcd.points = tiny3d.utility.Vector3dVector(np_points)

    # From tiny3d to numpy
    ...
    vector3ivector.attr("__doc__") = docstring::static_property(
            py::cpp_function([](py::handle arg) -> std::string {
                return R"(Convert int32 numpy array of shape ``(n, 3)`` to tiny3d format..
...
.. code-block:: python
    ...
    mesh = tiny3d.geometry.TriangleMesh()
    ...
    mesh.vertices = tiny3d.Vector3dVector(np_vertices)

    # From numpy to tiny3d
    mesh.triangles = tiny3d.Vector3iVector(np_triangles)
