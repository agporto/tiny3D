...
#define LogError(...)                     \
    Logger::LogError_(__FILE__, __LINE__, \
                      static_cast<const char *>(TINY3D_FUNCTION), __VA_ARGS__)
...
#define LogWarning(...)                                             \
    Logger::LogWarning_(__FILE__, __LINE__,                         \
                        static_cast<const char *>(TINY3D_FUNCTION), \
                        __VA_ARGS__)
...
public:
    ...
    /// redirect prints rather than printing to stdout. For example, in tiny3d's
    ...
    /// Set global verbosity level of tiny3d.
    ///
    ...
    /// Get global verbosity level of tiny3d.
