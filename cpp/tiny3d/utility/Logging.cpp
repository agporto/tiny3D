...
void Logger::VError [[noreturn]] (const char *file,
    ...
    std::string err_msg = fmt::format("[tiny3d Error] ({}) {}:{}: {}\n",
...
void Logger::VWarning(const char *file,
                      ...
                      const char *function,
                      const std::string &message) const {
    std::string err_msg = fmt::format("[tiny3d WARNING] {}", message);
...
void Logger::VInfo(const char *file,
                   ...
                   const char *function,
                   const std::string &message) const {
    std::string err_msg = fmt::format("[tiny3d INFO] {}", message);
    impl_->print_fcn_(err_msg);
}
...
void Logger::VDebug(const char *file,
                    ...
                    const char *function,
                    const std::string &message) const {
    std::string err_msg = fmt::format("[tiny3d DEBUG] {}", message);
    impl_->print_fcn_(err_msg);
}
